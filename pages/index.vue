        ...
        <div class="flex items-center">
          ...
          <div class="flex">
            <p
              ...
              @mouseover="hoverHeaderItem = headerItem"
              @mouseleave="hoverHeaderItem = ''"
              @click="activeHeaderItem = headerItem"
              :key="headerItem"
              class="font-medium px-2 mx-2 capitalize cursor-pointer rounded-lg transition duration-150"
              :class="[headerItem === activeHeaderItem || headerItem === hoverHeaderItem ? 'text-white bg-header-active-item' : 'text-gray-500']"
            >
              {{ headerItem }}
            </p>
          </div>
          <div class="px-2 mx-2 bg-green-100 text-white rounded cursor-pointer" style="padding-bottom: 2px; padding-top: 2px;">
            <p class="leading-5">Add Friend</p>
          </div>
        </div>
        <div class="flex items-center">
          <div class="flex items-center justify-center w-8 h-8 cursor-pointer text-gray-500 hover:text-white">
            <!-- prettier-ignore -->
          ...
          <div class="flex items-center justify-center w-8 h-8 cursor-pointer text-gray-500 hover:text-white mx-2">
            <!-- prettier-ignore -->
...
export default {
  data() {
    return {
      activeHeaderItem: "",
      hoverHeaderItem: "",
      headerItems: ["online", "all", "pending", "blocked"]
    };
  }
};
</script>
